...
AnimatedText* TextEffectsManager::CreateTextEffect(unsigned int lFontID, unsigned int lOutlineFontID, unsigned int lViewportID, TextDrawMode lDrawMode, TextEffect lEffect, TextDrawStyle lDrawStyle, vec3 lPosition, Colour lColour, Colour lOutlineColour, const string &lText, float lifeTime)
{
